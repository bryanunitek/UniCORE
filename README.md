...
- 2026-05-21 (4b36b91) — docs: add UniCORE.Desktop — client applications section
- 2026-05-21 (b571594) — docs: add UniCORE Positioning Principle with badge-denial-on-military clause
- 2026-05-21 (e8e995c) — docs: add (see DISCUSSIONS.md) hint in Contact section to match triad parity
- 2026-05-22 (a9305a2) — docs: add LICENSING.md — formal licensing reference with 11 worked scenarios
- 2026-05-22 (68d2691) — docs(licence): v0.03 — restore <4 Levels scenario + add UniCORE.GVB + UniCORE.Desktop substrate-lock
- 2026-05-22 (1dc7b14) — docs: complete version-marker sweep across public corpus
- 2026-05-23 (efde123) — docs(readme): add cross-reference pointer to UniVERSE/GETTING_STARTED.md
- 2026-06-03 (3714500) — docs(README): add UniVIEW and UniREPORT — view and reporting applications
- 2026-06-03 (3b979f1) — docs: add UniSaaS sister repos + SaaS deployment shape section
- 2026-06-03 (035a4e3) — docs: add Intelligent Integration Controller section to README
- 2026-06-03 (3497bb9) — docs: add NVarchar 3-mode, 10-level Mass Data Gen, IIC + Aderant
- 2026-06-04 (9c2f692) — docs(README): add Platforms and UI Surfaces section
- 2026-06-04 (2ea5a31) — docs(README): cross-reference Avalonia + DNN forked-upstream families
- 2026-06-04 (0ca80a5) — docs(README): cross-reference UniCORE-Claw substrate-harness pair
- 2026-06-04 (d6dfa0f) — docs(README): cross-reference Asterisk, Jitsi, Signal, XCP families
- 2026-06-06 (5295842) — docs(readme): add fleet inventory pointer (193 repos, Book canonical home)
- 2026-06-14 (377fd88) — docs: third pillar of Institutional AI doctrine — The Inconsistency Problem
- 2026-06-15 (dff972a) — docs(README): add Three Pillars framing block — Audience / Truth / Inconsistency
- 2026-06-19 (1dc8880) — docs(README): add strap-line to 'Why...' section
- 2026-07-01 (2c55a09) — Add Quancrypted as 4th NVarchar Data Mode (PQC data-at-rest end-state)
